...
copy %WINDIR%\system32\msvcr%version%.dll .\dll\64\
copy %WINDIR%\system32\msvcp%version%.dll .\dll\64\
copy %WINDIR%\system32\mfc%version%.dll .\dll\64\
copy %WINDIR%\system32\mfc%version%u.dll .\dll\64\
copy %WINDIR%\system32\mfcmifc%version%.dll .\dll\64\
copy %WINDIR%\system32\mfcm%version%.dll .\dll\64\
copy %WINDIR%\system32\mfcm%version%u.dll .\dll\64\

copy %WINDIR%\syswow64\msvcr%version%.dll .\dll\32\
copy %WINDIR%\syswow64\msvcp%version%.dll .\dll\32\
copy %WINDIR%\syswow64\mfc%version%.dll .\dll\32\
copy %WINDIR%\syswow64\mfc%version%u.dll .\dll\32\
copy %WINDIR%\syswow64\mfcmifc%version%.dll .\dll\32\
copy %WINDIR%\syswow64\mfcm%version%.dll .\dll\32\
copy %WINDIR%\syswow64\mfcm%version%u.dll .\dll\32\
